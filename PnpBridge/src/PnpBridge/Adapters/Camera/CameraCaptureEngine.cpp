    ...
    )
{
    ...
    // to read.
    {
        ...
        RETURN_IF_FAILED (spCaptureSource->GetCurrentDeviceMediaType(MF_CAPTURE_ENGINE_PREFERRED_SOURCE_STREAM_FOR_VIDEO_PREVIEW, &spSourceMediaType));
        ...
        RETURN_IF_FAILED (spPreviewSink->AddStream(MF_CAPTURE_ENGINE_PREFERRED_SOURCE_STREAM_FOR_VIDEO_PREVIEW, spTargetMediaType.Get(), nullptr, &dwStreamIndex));
    ...
    // read.
    {
        ...
        RETURN_IF_FAILED (spCaptureSource->GetCurrentDeviceMediaType(MF_CAPTURE_ENGINE_PREFERRED_SOURCE_STREAM_FOR_PHOTO, &spSourceMediaType));
        ...
        RETURN_IF_FAILED (spPhotoSink->AddStream(MF_CAPTURE_ENGINE_PREFERRED_SOURCE_STREAM_FOR_PHOTO, spJpegMediaType.Get(), nullptr, &dwStreamIndex));

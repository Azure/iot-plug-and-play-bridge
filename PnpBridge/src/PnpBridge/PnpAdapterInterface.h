...
typedef PNPBRIDGE_RESULT (*PNP_INTERFACE_INITIALIZE) (JSON_Object* adapterArgs);

typedef PNPBRIDGE_RESULT (*PNP_INTERFACE_SHUTDOWN)();

typedef PNPBRIDGE_RESULT (*BIND_PNP_INTERFACE)(PNPADAPTER_INTERFACE_HANDLE Interface, PNP_DEVICE_CLIENT_HANDLE pnpDeviceClientHandle, PPNPBRIDGE_DEVICE_CHANGE_PAYLOAD payload);

typedef PNPBRIDGE_RESULT (*RELEASE_PNP_INTERFACE)(PNPADAPTER_INTERFACE_HANDLE Interface);
